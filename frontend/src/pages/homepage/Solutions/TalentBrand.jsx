...
import style from "./techTalent.module.css"
...
export const TalentBrand = () => {
  return (
    ...
    <h1 id={style.tag}>Bring your talent story to life</h1>
    ...
    <div className={style.tags}>
      ...
      <p>Source: <Link style={{color:"green"}} to="">LinkedIn</Link></p>
    </div>
    <div className={style.feature}>
      <div>
